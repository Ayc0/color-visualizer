 ...
 */
var a,c,d,u;!function(t=".",e="__import__"){try{self[e]=new Function("u","return import(u)")}catch(i){const s=new URL(t,location),r=t=>{URL.revokeObjectURL(t.src),t.remove()};self[e]=t=>new Promise(((i,n)=>{const o=new URL(t,s);if(self[e].moduleMap[o])return i(self[e].moduleMap[o]);const h=new Blob([`import * as m from '${o}';`,`${e}.moduleMap['${o}']=m;`],{type:"text/javascript"}),l=Object.assign(document.createElement("script"),{type:"module",src:URL.createObjectURL(h),onerror(){n(new Error(`Failed to import: ${t}`)),r(l)},onload(){i(self[e].moduleMap[o]),r(l)}});document.head.appendChild(l)})),self[e].moduleMap={}}}("/color-visualizer/assets/");const p=globalThis.trustedTypes,m=p?p.createPolicy("lit-html",{createHTML:t=>t}):void 0,v=`lit$${(Math.random()+"").slice(9)}$`,f="?"+v,y=`<${f}>`,g=document,b=(t="")=>g.createComment(t),w=t=>null===t||"object"!=typeof t&&"function"!=typeof t,x=Array.isArray,$=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,S=/-->/g,C=/>/g,P=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,k=/'/g,H=/"/g,E=/^(?:script|style|textarea)$/i,L=(N=1,(t,...e)=>({_$litType$:N,strings:t,values:e})),U=Symbol.for("lit-noChange"),R=Symbol.for("lit-nothing"),M=new WeakMap,O=g.createTreeWalker(g,129,null,!1);var N;class A{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0;const o=t.length-1,h=this.parts,[l,a]=((t,e)=>{const i=t.length-1,s=[];let r,n=2===e?"<svg>":"",o=$;for(let l=0;l<i;l++){const e=t[l];let i,h,a=-1,c=0;for(;c<e.length&&(o.lastIndex=c,h=o.exec(e),null!==h);)c=o.lastIndex,o===$?"!--"===h[1]?o=S:void 0!==h[1]?o=C:void 0!==h[2]?(E.test(h[2])&&(r=RegExp("</"+h[2],"g")),o=P):void 0!==h[3]&&(o=P):o===P?">"===h[0]?(o=null!=r?r:$,a=-1):void 0===h[1]?a=-2:(a=o.lastIndex-h[2].length,i=h[1],o=void 0===h[3]?P:'"'===h[3]?H:k):o===H||o===k?o=P:o===S||o===C?o=$:(o=P,r=void 0);const d=o===P&&t[l+1].startsWith("/>")?" ":"";n+=o===$?e+y:a>=0?(s.push(i),e.slice(0,a)+"$lit$"+e.slice(a)+v+d):e+v+(-2===a?(s.push(void 0),l):d)}const h=n+(t[i]||"<?>")+(2===e?"</svg>":"");return[void 0!==m?m.createHTML(h):h,s]})(t,e);if(this.el=A.createElement(l,i),O.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=O.nextNode())&&h.length<o;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(v)){const i=a[n++];if(t.push(e),void 0!==i){const t=s.getAttribute(i.toLowerCase()+"$lit$").split(v),e=/([.?@])?(.*)/.exec(i);h.push({type:1,index:r,name:e[2],strings:t,ctor:"."===e[1]?z:"?"===e[1]?_:"@"===e[1]?F:I})}else h.push({type:6,index:r})}for(const e of t)s.removeAttribute(e)}if(E.test(s.tagName)){const t=s.textContent.split(v),e=t.length-1;if(e>0){s.textContent=p?p.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],b()),O.nextNode(),h.push({type:2,index:++r});s.append(t[e],b())}}}else if(8===s.nodeType)if(s.data===f)h.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(v,t+1));)h.push({type:7,index:r}),t+=v.length-1}r++}}static createElement(t,e){const i=g.createElement("template");return i.innerHTML=t,i}}function T(t,e,i=t,s){var r,n,o,h;if(e===U)return e;let l=void 0!==s?null===(r=i.Σi)||void 0===r?void 0:r[s]:i.Σo;const a=w(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==a&&(null===(n=null==l?void 0:l.O)||void 0===n||n.call(l,!1),void 0===a?l=void 0:(l=new a(t),l.T(t,i,s)),void 0!==s?(null!==(o=(h=i).Σi)&&void 0!==o?o:h.Σi=[])[s]=l:i.Σo=l),void 0!==l&&(e=T(t,l.S(t,e.values),l,s)),e}class B{constructor(t,e){this.l=[],this.N=void 0,this.D=t,this.M=e}u(t){var e;const{el:{content:i},parts:s}=this.D,r=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:g).importNode(i,!0);O.currentNode=r;let n=O.nextNode(),o=0,h=0,l=s[0];for(;void 0!==l;){if(o===l.index){let e;2===l.type?e=new j(n,n.nextSibling,this,t):1===l.type?e=new l.ctor(n,l.name,l.strings,this,t):6===l.type&&(e=new D(n,this,t)),this.l.push(e),l=s[++h]}o!==(null==l?void 0:l.index)&&(n=O.nextNode(),o++)}return r}v(t){let e=0;for(const i of this.l)void 0!==i&&(void 0!==i.strings?(i.I(t,i,e),e+=i.strings.length-2):i.I(t[e])),e++}}class j{constructor(t,e,i,s){this.type=2,this.N=void 0,this.A=t,this.B=e,this.M=i,this.options=s}setConnected(t){var e;null===(e=this.P)||void 0===e||e.call(this,t)}get parentNode(){return this.A.parentNode}get startNode(){return this.A}get endNode(){return this.B}I(t,e=this){t=T(this,t,e),w(t)?t===R||null==t||""===t?(this.H!==R&&this.R(),this.H=R):t!==this.H&&t!==U&&this.m(t):void 0!==t._$litType$?this._(t):void 0!==t.nodeType?this.$(t):(t=>{var e;return x(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.g(t):this.m(t)}k(t,e=this.B){return this.A.parentNode.insertBefore(t,e)}$(t){this.H!==t&&(this.R(),this.H=this.k(t))}m(t){const e=this.A.nextSibling;null!==e&&3===e.nodeType&&(null===this.B?null===e.nextSibling:e===this.B.previousSibling)?e.data=t:this.$(g.createTextNode(t)),this.H=t}_(t){var e;const{values:i,_$litType$:s}=t,r="number"==typeof s?this.C(t):(void 0===s.el&&(s.el=A.createElement(s.h,this.options)),s);if((null===(e=this.H)||void 0===e?void 0:e.D)===r)this.H.v(i);else{const t=new B(r,this),e=t.u(this.options);t.v(i),this.$(e),this.H=t}}C(t){let e=M.get(t.strings);return void 0===e&&M.set(t.strings,e=new A(t)),e}g(t){x(this.H)||(this.H=[],this.R());const e=this.H;let i,s=0;for(const r of t)s===e.length?e.push(i=new j(this.k(b()),this.k(b()),this,this.options)):i=e[s],i.I(r),s++;s<e.length&&(this.R(i&&i.B.nextSibling,s),e.length=s)}R(t=this.A.nextSibling,e){var i;for(null===(i=this.P)||void 0===i||i.call(this,!1,!0,e);t&&t!==this.B;){const e=t.nextSibling;t.remove(),t=e}}}class I{constructor(t,e,i,s,r){this.type=1,this.H=R,this.N=void 0,this.V=void 0,this.element=t,this.name=e,this.M=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this.H=Array(i.length-1).fill(R),this.strings=i):this.H=R}get tagName(){return this.element.tagName}I(t,e=this,i,s){const r=this.strings;let n=!1;if(void 0===r)t=T(this,t,e,0),n=!w(t)||t!==this.H&&t!==U,n&&(this.H=t);else{const s=t;let o,h;for(t=r[0],o=0;o<r.length-1;o++)h=T(this,s[i+o],e,o),h===U&&(h=this.H[o]),n||(n=!w(h)||h!==this.H[o]),h===R?t=R:t!==R&&(t+=(null!=h?h:"")+r[o+1]),this.H[o]=h}n&&!s&&this.W(t)}W(t){t===R?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class z extends I{constructor(){super(...arguments),this.type=3}W(t){this.element[this.name]=t===R?void 0:t}}class _ extends I{constructor(){super(...arguments),this.type=4}W(t){t&&t!==R?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}}class F extends I{constructor(){super(...arguments),this.type=5}I(t,e=this){var i;if((t=null!==(i=T(this,t,e,0))&&void 0!==i?i:R)===U)return;const s=this.H,r=t===R&&s!==R||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==R&&(s===R||r);r&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this.H=t}handleEvent(t){var e,i;"function"==typeof this.H?this.H.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this.H.handleEvent(t)}}class D{constructor(t,e,i){this.element=t,this.type=6,this.N=void 0,this.V=void 0,this.M=e,this.options=i}I(t){T(this,t)}}null===(c=(a=globalThis).litHtmlPlatformSupport)||void 0===c||c.call(a,A,j),(null!==(d=(u=globalThis).litHtmlVersions)&&void 0!==d?d:u.litHtmlVersions=[]).push("2.0.0-rc.2");
/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;function ft(){return new Worker("/color-visualizer/assets/generate-colors.worker.df6fc0e2.js",{type:"module"})}let yt;var gt=Object.defineProperty,bt=Object.getOwnPropertyDescriptor,wt=(t,e,i,s)=>{for(var r,n=s>1?void 0:s?bt(e,i):e,o=t.length-1;o>=0;o--)(r=t[o])&&(n=(s?r(e,i,n):r(n))||n);return s&&n&&gt(e,i,n),n};let xt=class extends ct{constructor(){super(...arguments),this.hue=0,this.luminance=0,this.chroma=0,this.width=500,this.height=300}onClick(t){const e=this.canvas;if(!e)return;const i=e.getBoundingClientRect(),s=Math.min(Math.max(t.clientX-i.x,0),this.width),r=Math.min(Math.max(t.clientY-i.y,0),this.height),n={chroma:Math.floor(s/this.width*132),luminance:Math.floor(100*(1-r/this.height)),hue:this.hue},o=new CustomEvent("change",{detail:n,bubbles:!0,composed:!0});this.dispatchEvent(o)}updated(){const t=this.canvas;if(!t)return;const e=t.getContext("2d");e&&function(t,e,i){const s=new ft;return yt&&yt.terminate(),yt=s,new Promise((r=>{s.onmessage=t=>{r(t.data.slice())},s.postMessage([t,e,i])}))}(this.hue,this.width,this.height).then((t=>{const i=new ImageData(t,this.width,this.height);e.putImageData(i,0,0)}))}render(){const t=Math.floor(this.chroma/132*this.width),e=Math.floor((1-this.luminance/100)*this.height);return L`
      <div class="wrapper">
        <canvas
          @click="${this.onClick}"
          width="${this.width}px"
        ...
        ></canvas>
        <div class="marker" style="top: ${e}px; left: ${t}px"></div>
      </div>
    `}};
/**
 * @license
...
var $t,St,Ct;xt.styles=K`
  ...
  `,wt([pt({type:Number,reflect:!0})],xt.prototype,"hue",2),wt([pt({type:Number,reflect:!0})],xt.prototype,"luminance",2),wt([pt({type:Number,reflect:!0})],xt.prototype,"chroma",2),wt([pt({type:Number})],xt.prototype,"width",2),wt([pt({type:Number})],xt.prototype,"height",2),wt([($t="canvas",vt({descriptor:t=>{const e={get(){var t;return null===(t=this.renderRoot)||void 0===t?void 0:t.querySelector($t)},enumerable:!0,configurable:!0};if(St){const i="symbol"==typeof t?Symbol():"__"+t;e.get=function(){var t;return void 0===this[i]&&(this[i]=null===(t=this.renderRoot)||void 0===t?void 0:t.querySelector($t)),this[i]}}return e}}))],xt.prototype,"canvas",2),wt([(Ct={passive:!0},vt({finisher:(t,e)=>{Object.assign(t.prototype[e],Ct)}}))],xt.prototype,"onClick",1),xt=wt([dt("lch-paint")],xt);var Pt=Object.defineProperty,kt=Object.getOwnPropertyDescriptor,Ht=(t,e,i,s)=>{for(var r,n=s>1?void 0:s?kt(e,i):e,o=t.length-1;o>=0;o--)(r=t[o])&&(n=(s?r(e,i,n):r(n))||n);return s&&n&&Pt(e,i,n),n};function Et(t){return t.toString(16).padStart(2,"0")}let Lt=class extends ct{constructor(){super(...arguments),this.chroma=0,this.luminance=0,this.hue=0,this.a=0,this.b=0,this.red=0,this.green=0,this.blue=0,this.setLCH=t=>{const e=o(t);this.luminance=e.l,this.chroma=e.c,this.hue=e.h},this.setLab=t=>{const e=h(t);this.luminance=e.l,this.a=e.a,this.b=e.b},this.setRGB=t=>{const e=l(t);this.red=Math.min(255,Math.max(0,Math.floor(e.r))),this.blue=Math.min(255,Math.max(0,Math.floor(e.b))),this.green=Math.min(255,Math.max(0,Math.floor(e.g)))},this.notifyParent=()=>{const t={chroma:this.chroma,luminance:this.luminance,hue:this.hue},e=new CustomEvent("change",{detail:t,bubbles:!0,composed:!0});this.dispatchEvent(e)},this.setFromLCH=({chroma:t=this.chroma,luminance:e=this.luminance,hue:i=this.hue}={})=>{const s=o(e,t,i);this.setLab(s),this.setRGB(s),this.setLCH(s),this.notifyParent()},this.setFromLab=({luminance:t=this.luminance,a:e=this.a,b:i=this.b}={})=>{const s=h(t,e,i);this.setLCH(s),this.setRGB(s),this.setLab(s),this.notifyParent()},this.setFromRGB=({red:t=this.red,green:e=this.green,blue:i=this.blue}={})=>{const s=l(t,e,i);this.setLCH(s),this.setLab(s),this.setRGB(s),this.notifyParent()}}connectedCallback(){super.connectedCallback(),this.setFromLCH()}renderInput(t,e,i,{min:s,max:r,unit:n=""}){return L`
      ...
      />
    `}willUpdate(t){const e=new Set(t.keys());e.delete("luminance"),e.delete("chroma"),e.delete("hue"),0===e.size&&this.setFromLCH()}render(){const t=`#${Et(this.red)}${Et(this.green)}${Et(this.blue)}`;return L`
      <div class="wrapper">
        <div class="group">
          <h2>LCH</h2>
